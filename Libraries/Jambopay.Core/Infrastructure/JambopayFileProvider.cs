...
namespace Jambopay.Core.Infrastructure
{
    /// <summary>
    /// IO functions using the on-disk file system
    /// </summary>
    public class JambopayFileProvider : PhysicalFileProvider, IJambopayFileProvider
    {
        /// <summary>
        /// Initializes a new instance of a JambopayFileProvider
        /// </summary>
        public JambopayFileProvider(string root)
            :base(Path.GetDirectoryName(root))
        {
        }
        ...
        public JambopayFileProvider(IWebHostEnvironment webHostEnvironment)
